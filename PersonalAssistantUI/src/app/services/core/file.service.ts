...
export class FileService {
  ...
  // public events
  public onCompleteUpload(queueObj: FileQueueObject, response: any): any {
  ...
  private _uploadFiles(files: FileQueueObject[]) {
    ...
    // upload file and report progress
    this.http.post(`${this.apiUrl}/files/multiple`, formData, { reportProgress: true }).subscribe(
      (event: any) => {
        alert("SUCCESS")
        // if (event.type === HttpEventType.UploadProgress) {
        //   this._uploadProgress(queueObj, event);
